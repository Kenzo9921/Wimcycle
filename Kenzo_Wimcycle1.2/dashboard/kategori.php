            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-3">
                         <!-- Button trigger modal delete-->
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $kategori['nama'] ?>">
                                    Delete
                                </button>

                                <!-- Modal delete-->
                                <div class="modal fade" id="exampleModal<?php echo $kategori['nama'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                    ...
                    <!-- Button trigger modal update-->
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModalUpdate<?php echo $kategori['nama'] ?>">
                                    Update
                                </button>

                                <!-- Modal update-->
                                <div class="modal fade" id="exampleModalUpdate<?php echo $kategori['nama'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
